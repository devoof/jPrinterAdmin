...
/**
 * The
 * <code>TransportMappings</code> factory can be used to create a transport
...
public class TransportMappings {
    ...
    /**
     * Returns the
     * <code>TransportMappings</code> singleton.
     *
    ...
    /**
     * Returns a
     * <code>TransportMapping</code> instance that is initialized with the
     * supplied transport address. If no such mapping exists,
     * <code>null</code> is returned. To register third party transport
     * mappings, please set the system property {@link #TRANSPORT_MAPPINGS} to a
     * transport mappings registration file, before calling this method for the
     * first time.
     *
     * @param transportAddress an <code>Address</code> instance that the
     * transport mapping to lookup has to support.
