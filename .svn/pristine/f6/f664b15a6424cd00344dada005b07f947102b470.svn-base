...
/**
 * UnsignedInteger32 type is an SNMP type that represents unsigned 32bit integer
...
public class UnsignedInteger32 extends AbstractVariable
    ...
    /**
     * Creates an
     * <code>UnsignedInteger32</code> from a
     * <code>long</code> value.
     *
     * @param value a <code>long</code> value which must not be greater 2^32-1
     * and not less zero.
     * @throws IllegalArgumentException if <code>value</code> &lt; 0 or &gt;
     * 2^32-1.
     */
    ...
    /**
     * Creates an unsigned integer from a signed int value. Negative values will
     * become 2^31-1 through 2^32-1.
     *
