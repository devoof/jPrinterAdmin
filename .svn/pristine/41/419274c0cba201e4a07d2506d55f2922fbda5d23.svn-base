...
public class JDBC4DatabaseMetaData extends DatabaseMetaData {
     ...
     * <code>unwrap</code> recursively on the wrapped object. If the receiver is
     * not a wrapper and does not implement the interface, then an
     ...
     * <p>
     * The
     * <code>ResultSet</code> is sorted by the NAME column
     * <p>
     *
