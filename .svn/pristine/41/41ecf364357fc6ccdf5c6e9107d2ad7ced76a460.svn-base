...
/**
 * The
 * <code>ArgumentParser</code> parsers a command line array into Java objects
 * and associates each object with the corresponding command line option
 ...
 * <li>&lt;type&gt; is one of 'i' (integer), 'l' (long), 'o' (octet string), and
 * 's' (string)</li>
 * </li>&lt;regex&gt; is a regular expression pattern that describes valid
 * values</li>
 * </li>&lt;default&gt; is a default value. If a default value is given, then a
 * mandatory option is in fact optional</li>
 * </ul>
 * </p>
 * <p>
...
public class ArgumentParser {
    ...
    /**
     * Creates an argument parser with the specified option and parameter
     * formats.
     *
     * @param optionFormat the option format pattern to parse (see
     * {@link ArgumentParser}).
     * @param parameterFormat the parameter format pattern to parse (see
     * {@link ArgumentParser}).
     */
     ...
     * to a
     * <code>List</code> of values. Each value may be of type
     * <code>Integer</code>,
     * <code>Long</code>, and
     * <code>String</code>.
     *
     * @param args the command line argument list.
     * @return Map a map that returns options and parameters in the order they
     * have been parsed, where each map entry has the option/parameter name as
     * key and the value as value.
     * @throws ParseException if the command line does not match the patterns
     ...
     *
     * @param optionValues a probably empty list of values - could      * be <code>null</code>.
     * @return the first option value in <code>optionValues</code> if it exists,
    ...
    /**
     * Gets the
     * <code>n</code>-th option value of a list of values - if available.
     *
     * @param args a parameter and options list.
     * @param name the option or parameter name to return
     * @param index the index (zero based) of the option/parameter value to
     * return.
     * @return the <code>n</code>-th (zero based) option value in
     ...
     * default option and parameter patterns can be overridden by setting the
     * system properties
     * <code>org.snmp4j.OptionFormat</code> and
     ...
     * <code>-o1[i{parameter1}] -o2[s,l]</code> and the default parameter
     * pattern is
     * <code>-param1[i] -param2[s<(udp|tcp):.*[/[0-9]+]?>] +optParam1[l{=-100}] ..
     * </code>
     * </p>
     *
     * @param args the command line arguments to match with the specified format
     * patterns.
     */
     ...
     * @param optionFormat the option format which is common to all commands (or
     * their super set)
     * @param commandSets the possible command sets, where each set is
     * identified by its command string in the first element of the command set.
     * @return the command set matching the command in the argument list.
     * @throws ParseException if the command found in <code>args</code> cannot
     * be found in the <code>commandSets</code>, or <code>null</code>      * if <code>args</code> does not contain any command.
     * @since 1.10
     */
