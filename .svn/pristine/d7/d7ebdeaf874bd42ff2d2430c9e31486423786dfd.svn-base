...
/**
 * The
 * <code>PduHandleCallback</code> can be used to get informed about a
...
public interface PduHandleCallback<P> {
     ...
     * notification can be used to get informed about a new PduHandle (just)
     * before a PDU has been sent out.
     *
     * @param handle a <code>PduHandle</code> instance that uniquely identifies
     * a request - thus in most cases the request ID.
