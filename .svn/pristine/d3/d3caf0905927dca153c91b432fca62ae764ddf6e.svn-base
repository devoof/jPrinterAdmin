...
/**
 * The
 * <code>SshAddress</code> represents a SSH transport addresses as defined by
 * RFC 5592 SnmpSSHAddress textual convention.
 *
 * @author Frank Fock
 * @version 2.0
 * @since 2.0
...
public class SshAddress extends TcpAddress {
    ...
    public boolean equals(Object o) {
        ...
        if (!getInetAddress().equals(that.getInetAddress())) {
            return false;
        }
        if (!addressURI.equals(that.addressURI)) {
            return false;
        }
