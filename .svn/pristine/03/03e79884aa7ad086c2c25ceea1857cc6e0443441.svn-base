...
/**
 * The
 * <code>VariantVariable</code> provides a decorator for any type of Variable
 * instance, to be able to intercept or monitor variable value modification by
 * using a {@link VariantVariableCallback}.
 * <p>
 * This class will work for implementations that use {@link #getSyntax()} method
 * to determine the variables syntax. However "instanceof" will not work.
 * <p>
 * In contrast to the native
 * <code>Variable</code> implementations,
 * <code>VariantVariable</code> can be modified dynamically (i.e. while a PDU is
 * being BER encoded where this variable has been added to) without causing BER
 * encoding errors.
 *
 * @author Frank Fock
 * @version 1.8
...
public class VariantVariable extends AbstractVariable implements
     ...
     *
     * @param initialVariable a <code>Variable</code>.
     * @param callback a callback handler that is called before the value is to
     * be modified and after it has been modified.
     */
    public VariantVariable(Variable initialVariable,
