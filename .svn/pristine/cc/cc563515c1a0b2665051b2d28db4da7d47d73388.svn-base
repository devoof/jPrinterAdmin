...
/**
 * The
 * <code>SecureTarget</code> is an security model independent abstract class for
 * all targets supporting secure SNMP communication.
 *
...
public abstract class SecureTarget
     ...
     *
     * @param address an <code>Address</code> instance denoting the transport
     * address of the target.
     * @param securityName a <code>OctetString</code> instance representing the
     * security name of the USM user used to access the target.
     */
