...
/**
 * The
 * <code>UsmTimeEntry</code> class represents time synchronization information
 * associated with an engine ID.
 *
 * @author Frank Fock
 * @version 1.0
 */
public class UsmTimeEntry implements Serializable {
     ...
     *
     * @param engineID the engine ID for which time synchronization information
     * is created.
     * @param engineBoots the number of engine boots of the engine.
     * @param engineTime the time in seconds elapsed since the last reboot of
     * the engine.
     */
    ...
    /**
     * Sets the engine time which also sets the last received engine time to the
     * supplied value.
     *
     * @param engineTime the time in seconds elapsed since the last reboot of
     * the engine.
