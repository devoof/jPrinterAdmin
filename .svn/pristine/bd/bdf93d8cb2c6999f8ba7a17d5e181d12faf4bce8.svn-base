...
public class ResponseEvent extends EventObject {
    ...
    /**
     * Creates an
     * <code>ResponseEvent</code> instance.
     *
     * @param source the event source.
     * @param peerAddress the transport address of the entity that send the
     * response.
     * @param request the request PDU (must not be <code>null</code>).
     * @param response the response PDU or <code>null</code> if the request
     * timed out.
    ...
    /**
     * Creates an
     * <code>ResponseEvent</code> instance with an exception object indicating a
     ...
     */
    public ResponseEvent(Snmp source,
            Address peerAddress,
    ...
    /**
     * Gets the user object that has been supplied to the asynchronous request null     {@link Session#send(PDU pdu, org.snmp4j.Target target, Object userHandle,
   * ResponseListener listener)}.
    ...
    /**
     * Gets the exception object from the exception that has been generated when
     * the request processing has failed due to an error.
     *
     ...
     *
     * @return the transport <code>Address</code> of the command responder that
     * send this response, or <code>null</code> if no response has been received
