...
public class UserTarget extends SecureTarget {
     ...
     * @param securityName the USM security name to be used to access the
     * target.
     * @param authoritativeEngineID the authoritative engine ID as a possibly
     * zero length byte array which must not be <code>null</code>.
     */
     ...
     *
     * @param authoritativeEngineID a possibly zero length byte array (must not
     * be <code>null</code>).
     */
