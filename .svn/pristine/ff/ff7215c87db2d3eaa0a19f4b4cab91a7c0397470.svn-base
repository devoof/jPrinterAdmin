...
/**
 * A
 * <code>VariableBinding</code> is an association of a object instance
...
public class VariableBinding
    ...
    /**
     * Creates a variable binding with a zero length OID and a {@link Null}
     * value.
     */
     ...
     *
     * @param oid an OID (must not be <code>null</code>) that is cloned when
     * added to this binding.
     */
     ...
     * {@link VariableTextFormat} configured by {@link SNMP4JSettings}.
     *
     * @return a string of the form <code>&lt;Variable&gt;</code>.
     * @since 1.10
     */
    ...
    /**
     * Create an array of {@link VariableBinding}s based on the provided OIDs.
     *
     * @param oids an array of OIDs (must not be null).
     * @return an array of {@link VariableBinding}s where each the n-th
     * binding's OID is the n-th OID out of <code>oids</code>.
     * @since 2.1
     */
