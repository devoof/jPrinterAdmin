...
/**
 * The
 * <code>USM</code> class implements the User Based Security Model (USM) as
 * defined in RFC 3414.
 * <p>
 * When a user is added or removed from the USM, a
 * <code>UsmUserEvent</code> is fired and forwarded to registered listeners.
 *
 * @author Frank Fock
 * @version 2.0
 */
public class USM extends SNMPv3SecurityModel {
    ...
    /**
     * Returns the number of seconds since the value of the engineBoots object
     * last changed. When incrementing this object's value would cause it to
     * exceed its maximum, engineBoots is incremented as if a re-initialization
     * had occurred, and this object's value consequently reverts to zero.
     *
     * @return a positive integer value denoting the number of seconds since the
     * engineBoots value has been changed.
     * @since 1.2
     */
     ...
     *
     * @param engineID the engineID of the user (may be <code>null</code> if any
     * target should match).
     * @param securityName the security name of the user to earch for.
     * @return <code>true</code> if the user is either known for the specified
     * engine ID or without a specific engine ID (discovery only).
     * @since
     */
    ...
    /**
     * Adds an USM user to the internal user name table. The user's security
     ...
     * engine ID - other engine IDs cannot be discovered on behalf of this
     * entry.
     *
     * @param userName a user name.
     * @param engineID the authoritative engine ID to be associated with this
     * entry. If <code>engineID</code> is <code>null</code> this method behaves
     * exactly like {@link #addUser(OctetString userName, UsmUser user)}.
     * @param user the <code>UsmUser</code> to add.
     */
     ...
     * <code>UsmUserEvent</code>. If the corresponding user entry does not yet
     * exist then it will be added.
     *
     * @param entry an <code>UsmUserEntry</code> instance not necessarily the
     * same as an already existing entry.
     * @since 1.2
     */
    ...
    /**
     * Returns the
     * <code>UsmUserTable</code> instance used by the USM for local storage of
     * USM user information. The returned table should not be modified, because
     * modifications will not be reported to registered
     * <code>UsmUserListener</code>s.
     *
     * @return the <code>UsmUserTable</code> instance containing the users known
     * by this USM.
     */
    ...
    /**
     * Returns the
     * <code>UsmTimeTable</code> instance used by this USM for holding timing
     ...
     * <code>null</code>
     * @param userName a user name.
     * @return the removed <code>UsmUser</code> instance associate with the
     * given <code>userName</code> or <code>null</code> if such a user could not
     * be found.
     */
     ...
     * message.
     *
     * @return <code>true</code> if discovery is enabled, <code>false</code>
     * otherwise.
     */
     ...
     *
     * @param engineDiscoveryEnabled <code>true</code> if discovery should be
    ...
    /**
     * Removes a
     * <code>UsmUserListener</code>.
     *
     * @param l a previously added <code>UsmUserListener</code>.
     */
    ...
    /**
     * Adds a
     * <code>UsmUserListener</code> that should be informed whenever the
     ...
     * forces an engine time rediscovery the next time the SNMP engine with the
     * supplied ID is contacted.
     *
