...
public class Blob implements java.sql.Blob, OutputStreamWatcher {
     ...
     * <code>Blob</code> object represents to be
     * <code>len</code> bytes in length.
     * <p>
     * <b>Note:</b> If the value specified for
     * <code>len</code> is greater then the length+1 of the
     * <code>BLOB</code> value then the behavior is undefined. Some JDBC drivers
     * may throw a
     * <code>SQLException</code> while other drivers may support this operation.
     *
     ...
     * <code>Blob</code> object and releases the resources that it holds. The
     * object is invalid once the
     * <code>free</code> method is called.
     * <p>
     * After
     * <code>free</code> has been called, any attempt to invoke a method other
     * than
     * <code>free</code> will result in a
     * <code>SQLException</code> being thrown. If
     * <code>free</code> is called multiple times, the subsequent calls to
     * <code>free</code> are treated as a no-op.
     * <p>
     *
