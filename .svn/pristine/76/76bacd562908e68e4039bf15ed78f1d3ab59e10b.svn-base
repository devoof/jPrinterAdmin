...
/**
 * The
 * <code>OctetString</code> class represents the SMI type OCTET STRING.
 *
 * @author Frank Fock
 * @version 1.8
 * @since 1.0
...
public class OctetString extends AbstractVariable
     ...
     *
     * @param octetString an <code>OctetString</code> to append to this octet
     * string.
     */
     ...
     * <code>OctetString</code>. Calling this method is identical to
     * <I>append(string.getBytes())</I>.
     *
     ...
     *
     * @param v the byte array to compare with this OctetStrings value member.
     * @return <code>Arrays.equals(value, (byte[])v)</code>
     * @since 2.0
     */
     ...
     * @return <code>true</code> if the bytes of this octet string up to the
     * length of <code>prefix</code> equal those of <code>prefix</code>.
     * @since 1.2
     */
     ...
     * characters as defined by <code>Character.isISOControl(char)</code> except
     * if these ISO control characters are all whitespace characters as defined
     * by <code>Character.isWhitespace(char)</code> and not
     ...
     *
     * @param hexString a string of characters a-f,A-F,0-9 with length 2*b,
     * where b is the length of the string in bytes.
     * @return an OctetString instance with the      * length <code>hexString.length()/2</code>.
     * @since 2.1
     */
     ...
     * specified. There will be no separation characters, but each byte will be
     * represented by
     * <code>round(log(256)/log(radix))</code> digits.
     *
     * @param radix the radix to use in the string representation.
     * @return a string representation of this ocetet string in the specified
     * radix.
     * @since 1.6
     */
     ...
     * <code>BERSerializable</code> object in bytes when encoded according to
     ...
     *
     * @param mask a mask where the n-th bit corresponds to the n-th bit in the
     * returned OctetString.
    ...
    /**
     * Splits an
     * <code>OctetString</code> using a set of delimiter characters similar to
     * how a StringTokenizer would do it.
     *
    ...
    /**
     * Creates an
     * <code>OctetString</code> from an byte array.
     *
     * @param value a byte array that is copied into the value of the created
     * <code>OctetString</code> or <code>null</code>.
     * @return an OctetString or <code>null</code> if <code>value</code> * is <code>null</code>.
     * @since 1.7
     */
