...
/**
 * The
 * <code>DefaultThreadFactory</code> creates {@link WorkerTask} instances that
 * allow concurrent execution of tasks. By default it uses a timeout of 60
 * seconds (1 min.) when joining threads on behalf of an call of the
...
public class DefaultThreadFactory implements ThreadFactory {
     ...
     *
     * @param millis the time to wait. 0 waits forever.
     * @since 1.10.2
     */
