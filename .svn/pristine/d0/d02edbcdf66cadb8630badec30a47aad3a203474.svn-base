...
/**
 * The
 * <code>Counter32</code> class allows all the functionality of unsigned
...
public class Counter32 extends UnsignedInteger32 {
    ...
    /**
     * Increment the value of the counter by one. If the current value is 2^32-1
     * (4294967295) then value will be set to zero.
     */
