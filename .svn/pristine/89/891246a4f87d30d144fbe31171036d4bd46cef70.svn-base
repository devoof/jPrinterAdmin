...
/**
 * The
 * <code>SnmpConstants</code> class holds constants, ObjectIDs and Message
 * strings used within SNMP4J.
 *
 * @author Frank Fock
 * @version 1.8
 */
public final class SnmpConstants {
     ...
     *
     * @param oid an OID.
     * @return -1 if the supplied OID is not a generic trap, otherwise a value
     * >= 0 will be returned that denotes the generic trap ID.
     */
