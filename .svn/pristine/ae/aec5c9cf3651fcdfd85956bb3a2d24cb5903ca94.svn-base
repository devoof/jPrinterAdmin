...
/**
 * The
 * <code>IpAddress</code> class represents an IPv4 address SNMP variable.
 *
 * @author Frank Fock
 * @version 1.10.3
 * @since 1.0
...
public class IpAddress extends SMIAddress implements AssignableFromByteArray {
     ...
     *
     * @param address an <code>InetAddress</code> instance (must not necessarily
     * be a IPv4 address).
     */
    ...
    /**
     * Create an IP address from a raw IP address. The argument is in network
     * byte order: the highest order byte of the address is in first element of
     ...
     *
     * @param address an IP address string which may be a host name or a
