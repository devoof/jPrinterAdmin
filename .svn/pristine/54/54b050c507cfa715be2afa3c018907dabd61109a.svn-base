...
//	private long masterFailTimeMillis = 0L;
    ...
    /**
     * Terminates an open connection. Calling
     * <code>abort</code> results in:
     * <ul>
     ...
     * <p>
     * Calling
     * <code>abort</code> marks the connection closed and releases any
     * resources. Calling
     ...
     * as closed and the
     * <code>Executor</code> that was passed as a parameter to abort may still
     * be executing tasks to release resources.
     * <p>
     * This method checks to see that there is an
     * <code>SQLPermission</code> object before allowing the method to proceed.
     * If a
