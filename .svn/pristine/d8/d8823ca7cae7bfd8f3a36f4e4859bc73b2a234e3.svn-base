...
/**
 * The
 * <code>WorkerPool</code> interface models an abstract pool of workers
...
public interface WorkerPool {
    ...
    /**
     * Executes a task on behalf of this worker pool. If all threads are
     * currently busy, this method call blocks until a worker gets idle again
     ...
     *
     * @return <code>true</code> if all workers are idle.
     */
    boolean isIdle();
}
