...
/**
 * The
 * <code>TcpTransportMapping</code> is the abstract base class for TCP transport
 * mappings.
 *
 * @author Frank Fock
 * @version 1.7
...
public abstract class TcpTransportMapping
     ...
     *
     * @return the <code>Address</code> used by this transport mapping. The
     * returned instance must not be modified!
     */
    ...
    /**
     * Returns the
     * <code>MessageLengthDecoder</code> used by this transport mapping.
     *
    ...
    /**
     * Sets the
     * <code>MessageLengthDecoder</code> that decodes the total message length
     * from the header of a message.
     *
