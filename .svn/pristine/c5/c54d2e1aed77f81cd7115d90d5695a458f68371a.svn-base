...
/**
 * The interface
 * <code>BERSerializable</code> has to be implemented by any data type class
 * that needs to be serialized using the Basic Encoding Rules (BER) that
 * provides enconding rules for ASN.1 data types.
 *
