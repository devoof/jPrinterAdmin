...
/**
 * The
 * <code>AuthenticationProtocol</code> interface defines a common interface for
 * all SNMP authentication protocols.
 *
 * @author Frank Fock
 * @version 1.0
 */
public interface AuthenticationProtocol extends SecurityProtocol {
     ...
     *
     * This method fills the authentication parameters field of the given
     * message. The parameter
     * <code>digestOffset</code> offset is pointing inside the message buffer
     * and must be zeroed before the authentication value is computed.
     *
     * @param authenticationKey the authentication key to be used for
     * authenticating the message.
     * @param message the entire message for which the digest should be
     * determined.
     * @param messageOffset the offset in <code>message</code> where the message
     * actually starts.
     * @param messageLength the actual message length (may be smaller than
     * <code>message.length</code>).
     * @param digest the offset in <code>message</code> where to store the
     * digest.
     * @return <code>true</code> if the message digest has been successfully
     * computed and set, <code>false</code> otherwise.
     */
     ...
     *
     * This method checks if the value in the authentication parameters field of
     ...
     * authenitcation key. The length of the old key (e.g. 16 for MD5, 20 for
     * SHA) must match the length of the new key.
     *
