...
/**
 * The
 * <code>PrivacyProtocol</code> interface defines a common interface for all
...
public interface PrivacyProtocol extends SecurityProtocol {
     ...
     * engine ID.
     *
     * @param unencryptedData the unencrypted data. This byte array may contain
     * leading and trailing bytes that will not be encrypted.
     * @param offset the offset into the <code>unencryptedData</code> where to
     * start encryption.
     * @param length the length of the substring starting at <code>offset</code>
     * to encrypt.
     ...
     * @param decryptParams returns the decryption parameters needed to decrypt
     * the data that has been encrypted by this method.
     ...
     * engine ID.
     *
     * @param cryptedData the crypted data. This byte array may contain leading
     * and trailing bytes that will not be decrypted.
    ...
    /**
     * Gets the length of a scoped PDU when encrypted with this security
     * protocol.
     *
     ...
     * protocol.
     *
     * @return a positive integer denoting the length of decryption parameters
     * returned by this security protocol.
     */
     ...
     *
     * @param shortKey the short key that was generated using
     * {@link AuthenticationProtocol#passwordToKey} function.
     * @param password the password to use for key extension.
     * @param engineID the SNMP engine ID of the authoritative engine.
     * @param authProtocol the authentication protocol that should be used.
     * @return the extended key or <code>shortKey</code> if no extension is
     * needed.
     * @since 1.9
     */
