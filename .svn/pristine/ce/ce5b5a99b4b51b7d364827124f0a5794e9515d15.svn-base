...
/**
 * The
 * <code>SecurityProtocols</code> class holds all authentication and privacy
 * protocols for a SNMP entity.
 * <p>
 * To register security protocols other than the default, set the system
 * property {@link #SECURITY_PROTOCOLS_PROPERTIES} to a customized version of
 * the
 * <code>SecurityProtocols.properties</code> file. The path has to be specified
...
public class SecurityProtocols implements Serializable {
     ...
     *
     * The names of the SecurityProtocols to add are read from a properties
     * file.
     *
    ...
    /**
     * Add the given {@link AuthenticationProtocol}. If an authentication
     * protocol with the supplied ID already exists, the supplied authentication
     * protocol will not be added and the security protocols will not be
     * unchang.
     *
     * @param auth the AuthenticationProtocol to add (an existing authentication
     * protcol with <code>auth</code>'s ID remains unchanged).
     */
     ...
     *
     * @param id The unique ID (specified as {@link OID}) of the
     * AuthenticationProtocol.
     * @return the AuthenticationProtocol object if it was added before, or null
     * if not.
     */
    ...
    /**
     * Add the given {@link PrivacyProtocol}. If a privacy protocol with the
     * supplied ID already exists, the supplied privacy protocol will not be
     * added and the security protocols will not be changed.
     *
     ...
     * @param id The unique ID (specified as {@link OID}) of the
     * PrivacyProtocol.
     * @return the {@link PrivacyProtocol} object if it was added before, or
     * null if not.
     */
     ...
     *
     * @param authProtocolID an <code>OID</code> identifying the authentication
     * protocol to use.
     ...
     *
     * @param privProtocolID an <code>OID</code> identifying the privacy
     * protocol the key should be created for.
     * @param authProtocolID an <code>OID</code> identifying the authentication
     * protocol to use.
     * @param passwordString the authentication pass phrase.
     * @param engineID the engine ID of the authoritative engine.
     ...
     *
     * @return the maximum authentication key length of all authentication
     * protocols that have been added to this <code>SecurityProtocols</code>
     * instance.
     */
    ...
    /**
     * Gets the maximum privacy key length of the currently known privacy
     * protocols.
     *
     * @return the maximum privacy key length of all privacy protocols that have
     * been added to this <code>SecurityProtocols</code> instance.
     */
