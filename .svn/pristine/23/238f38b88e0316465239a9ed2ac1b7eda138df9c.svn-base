...
/**
 * The
 * <code>SecurityModels</code> class is a collection of all supported security
 * models of a SNMP entity.
 *
...
public class SecurityModels {
     ...
     *
     * @param models an array of {@link SecurityModel} instances.
     * @return a new instance of SecurityModels that contains the supplied
     * models.
     * @since 1.10
     */
     ...
     *
     * @param model a <code>SecurityModel</code>. If a security model with the
     * same ID already
     */
