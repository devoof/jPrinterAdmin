...
public interface PDUFactory {
    ...
    /**
     * Create a
     * <code>PDU</code> instance for the supplied target. The created PDU has to
     * be compliant to the SNMP version defined by the supplied target. For
     * example, a SNMPv3 target requires a ScopedPDU instance.
     *
