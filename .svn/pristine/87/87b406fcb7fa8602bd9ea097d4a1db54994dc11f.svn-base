...
/**
 * The
 * <code>VariableTextFormat</code> provides a textual representation of SNMP
 * {@link Variable}s, in dependence of their associated (instance) OID.
 *
 * @author Frank Fock
 * @version 1.10
 * @since 1.10
...
public interface VariableTextFormat {
     ...
     * specification of the variable into account and has to format it based on
     * its type only.
     * @param variable the variable to format.
     * @param withOID if <code>true</code> the <code>instanceOID</code> should
     * be included in the textual representation to form a
     * {@link VariableBinding} representation.
     ...
     * @throws ParseException if the variable binding cannot be parsed
     * successfully.
     */
     ...
     * OBJECT-TYPE OID.
     *
     * @param classOrInstanceOID the instance OID <code>variable</code> is
