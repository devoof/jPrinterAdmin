...
/**
 * The
 * <code>VariantVariableCallback</code> can be implemented by objects that want
 * to intercept/monitor reading and writing of a
 * <code>VariantVariable</code>'s value.
 *
 * @author Frank Fock
 * @version 1.7
 */
