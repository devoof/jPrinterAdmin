...
public class CallableStatement extends PreparedStatement implements
    ...
    protected class CallableStatementParamInfoJDBC3 extends CallableStatementParamInfo
         ...
         * implement the interface and is not a wrapper, return false. This
         ...
         * expensive
         * <code>unwrap</code> calls that may fail. If this method returns true
         * then calling
         ...
         * Otherwise the object is the result of calling
         * <code>unwrap</code> recursively on the wrapped object. If the
         * receiver is not a wrapper and does not implement the interface, then
         * an
