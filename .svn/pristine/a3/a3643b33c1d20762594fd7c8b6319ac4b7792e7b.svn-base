...
/**
 * The
 * <code>RetrievalEvent</code> is an abstract class representing the result of
 * one or more GET/GETNEXT/GETBULK requests.
 *
 * @author Frank Fock
 * @version 1.8
 * @since 1.8
...
public abstract class RetrievalEvent extends EventObject {
     ...
     * @param source the source of the event.
     * @param userObject the user object or <code>null</code>.
     * @param variableBindings an array of <code>VariableBinding</code>
     * instances.
     */
     ...
     * {@link #STATUS_OK} indicates success, all other values indicate failure
     * of the operation.
     */
    ...
    /**
     * Gets the user object that has been specified by the user when the
     * retrieval operation that fired this event has been requested.
     *
