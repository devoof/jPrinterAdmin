...
public class BER {
    ...
    /**
     * The
     * <code>MutableByte</code> class serves for exchanging type information
     ...
     * octets. @param length the length of the object. The maximum length is
     * 0xFFFFFFFF; @throws IOException
     */
    ...
    /**
     * Encodes an ASN.1 header for an object with the ID and length specified
     * with a fixed length of the encoded length as supplied.
     *
     * @param os an <code>OutputStream</code> to which the header is encoded.
     * @param type the type of the ASN.1 object. Must be < 30, i.e. no extension
     * octets. @param length the length of the object. The maximum length is
     * 0xFFFFFFFF; @param numBytesLength the number of bytes used to encode the
     * length of the length. @throws IOExce
     * p
     * tion
     */
    public static void encodeHeader(OutputStream os, int type, int length,
     ...
     * @param os an <code>OutputStream</code> to which the length is encoded.
     * @param length the length of the object. The maximum length is 0xFFFFFFFF;
     * @param numLengthBytes the number of bytes to be used to encode the length
     * using the long form.
     * @throws IOException
     */
    public static void encodeLength(OutputStream os, int length,
     ...
     *
     * @param value an array of unsigned integer values representing an object
     * identifier.
