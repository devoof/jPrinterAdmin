...
/**
 * The
 * <code>DefaultSshTransportMapping</code> implements a TCP transport mapping
 * with TLS according to RFC 5592 (named SSHTM therein).
 *
 * @author Frank Fock
 * @version 2.0
 * @since 2.0
...
public class DefaultSshTransportMapping extends AbstractTransportMapping<SshAddress> {
    ...
    protected class SessionID {
        ...
        public boolean equals(Object o) {
            ...
            if (address != null ? !address.equals(sessionID.address) : sessionID.address != null) {
                return false;
            }
