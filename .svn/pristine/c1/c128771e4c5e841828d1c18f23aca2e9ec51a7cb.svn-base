 ...
 *
 * This class uses DES in CBC mode to encrypt the data. The protocol is defined
 * in the IETF standard "User-based Security Model (USM) for SNMPv3".
 *
 * @author Jochen Katz
 * @version 1.9
 */
public class PrivDES
     ...
     * engine ID.
     *
     * @param cryptedData the data to decrypt.
     * @param offset the offset into <code>cryptedData</code> to start
     * decryption.
     * @param length the length of the data to decrypt.
     * @param decryptionKey the decrpytion key.
     * @param engineBoots the engine boots counter.
