...
/**
 * The
 * <code>LogFactory</code> singleton is used by SNMP4J to determine the logging
 * framework used to process SNMP4J log messages. By default {@link NoLogger}
 * instances are used.
 *
 * @author Frank Fock
 * @version 1.8
...
public class LogFactory {
     ...
     * {@link NoLogger} logger instance which disables logging. Overwrite this
     * method the return a custom logger to enable logging for SNMP4J.
     *
     * @param c the class for which a logger needs to be created.
     * @return the <code>LogAdapter</code> instance.
     */
    ...
    /**
     * Sets the log factory to be used by SNMP4J. Call this method before any
     * other SNMP4J class is referenced or created to set and use a custom log
     * factory.
     *
    ...
    /**
     * Gets the log factory to be used by SNMP4J. If the log factory has not
     * been initialized by {@link #setLogFactory} a new instance of
     * {@link LogFactory} is returned.
     *
