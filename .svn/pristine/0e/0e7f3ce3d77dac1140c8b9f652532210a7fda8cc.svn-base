...
/**
 * The
 * <code>Counter64</code> class represents a 64bit unsigned integer type. It is
 * used for monotonically increasing values that wrap around at 2^64-1
...
public class Counter64 extends AbstractVariable
    ...
    /**
     * Increment the value of the counter by one. If the current value is 2^63-1
     * (9223372036854775807) then value will be set to -2^63. Nevertheless, the
     * BER encoded value of this counter will always be unsigned!
     */
