...
/**
 * The
 * <code>MPv2c</code> is the message processing model for SNMPv2c (community
 * based SNMPv2).
 *
 * @author Frank Fock
 * @version 1.9.1
...
public class MPv2c implements MessageProcessingModel {
    ...
    /**
     * Creates a SNMPv2c message processing model with a PDU factory for
     * incoming messages that uses {@link PDU}.
     */
    public MPv2c() {
    }
