...
/**
 * The
 * <code>GenericAddress</code> implements the decorator and factory design
 * pattern to provide a generic address type.
 * <p>
...
public class GenericAddress extends SMIAddress {
    ...
    /**
     * Register Address classes from a properties file. The registered address
     * types are used by the {@link GenericAddress#parse(String)} method to
     * type-safe instantiate sub-classes from
     * <code>Address</code> from a
     * <code>String</code>.
     */
     ...
     *
     * @param address an address string with a leading type specifier as defined
     * in the "address.properties". The format is <code>"type:address"</code>
     * where the format of <code>address</code> depends on <code>type</code>.
     ...
     * @throws IllegalArgumentException if the address type indicator supplied
     * is not know.
     */
     ...
     * {@link Address} class.
     *
     * @param addressClass an implementation class of {@link Address}.
     * @return the corresponding transport domain prefix as defined by the IANA
     * registry "SNMP Transport Domains" if the <code>addressClass</code> has
     * been registered with a domain prefix, <code>null</code> otherwise.
     * @since 2.0
     */
