...
/**
 * The
 * <code>TransportStateReference</code> class holds information defined by RFC
 * 5343 for the tmStateReference ASI elements. Objects of this class are cached
 * by security aware {@link TransportMapping}s and transport aware
...
public class TransportStateReference {
    ...
    /**
     * Checks if transport, address, securityName and transportSecurityLevel are
     * valid (not null).
     *
