...
/**
 * This
 * <code>CommonTimer</code> defines the subset interface used from
...
public interface CommonTimer {
     ...
     *
     * <p>In fixed-delay execution, each execution is scheduled relative to the
     ...
     *
     * <p>Fixed-delay execution is appropriate for recurring activities that
     ...
     *
     * <p>Note that calling this method from within the run method of a timer
     ...
     *
     * <p>This method may be called repeatedly; the second and subsequent calls
     * have no effect.
     */
    public void cancel();
}
