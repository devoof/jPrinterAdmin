...
public class CreateDatabase extends javax.swing.JDialog {
    ...
    private void createTables(Connection conn) throws SQLException {
        ...
        stat.executeUpdate("CREATE TABLE PRINTER_VALUES (printer_id int NOT NULL, request_value_id int NOT NULL, request_value VARCHAR(100), PRIMARY KEY (printer_id, request_value_id))");
