...
import getPrinterData.Snmpwalk;
 ...
 * @author stefan
 */
public final class SnmpWalkWindow extends javax.swing.JDialog {

    public SnmpWalkWindow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public SnmpWalkWindow(javax.swing.JDialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
        jTextFieldIP.setText(PrinterWindow.ip);
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("SNMP-WALK")); // NOI18N
        ...
        jLabel5.setText(bundle.getString("SEARCH")); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldIP, javax.swing.GroupLayout.PREFERRED_SIZE, 212, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jButton1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTextFieldSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 244, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    public void getSnmpValues() {
        list = (ArrayList<String[]>) Snmpwalk.getSnmpWalk(this.jTextFieldIP.getText());
        createTableContent();
    }
    ...
    public void createTableContent() {
        ...
        for (int ii = 0; ii < list.size(); ii++) {
            if (Search.length() == 0 || list.get(ii)[0].toLowerCase().contains(Search) || list.get(ii)[1].toLowerCase().contains(Search) || list.get(ii)[2].toLowerCase().contains(Search)) {
                obj[i++] = (String[]) list.get(ii);
            }
        }
        ...
        this.jTable1.setModel(new javax.swing.table.DefaultTableModel(
                obj,
                new String[]{
            java.util.ResourceBundle.getBundle("jprinteradmin/language").getString("OID"), java.util.ResourceBundle.getBundle("jprinteradmin/language").getString("KIND"), java.util.ResourceBundle.getBundle("jprinteradmin/language").getString("VALUE")
        }) {
