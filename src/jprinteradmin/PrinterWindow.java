...
public class PrinterWindow extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel6.setText(bundle.getString(": Ø")); // NOI18N
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        try {
            ...
            String updateQuery = "UPDATE PRINTER_VALUES SET request_value = '" + Utility.escapeSqlString(this.jTextFieldValue.getText()) + "' WHERE printer_id = " + printerId + " AND request_value_id =" + vid; //NOI18N
            Statement st = Database.conn.createStatement();
            if (st.executeUpdate(updateQuery) == 0) {
                String insertQuery = "INSERT INTO PRINTER_VALUES (printer_id, request_value_id,request_value) VALUES (" + printerId + ", " + vid + ", '" + Utility.escapeSqlString(this.jTextFieldValue.getText()) + "')";
