...
/**
 * The
 * <code>JavaLogFactory</code> implements a SNMP4J LogFactory for Java logging.
 * In order to use Java's
 * <code>java.util.logging</code> for logging SNMP4J log messages the static
 * {@link LogFactory#setLogFactory} method has to be used before any SNMP4J
 * class is referenced or instantiated.
 *
 * @author Frank Fock
 * @version 1.7.2
 */
