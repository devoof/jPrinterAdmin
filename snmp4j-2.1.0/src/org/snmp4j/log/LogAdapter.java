...
/**
 * The
 * <code>LogAdapter</code> specifies the logging interface used by SNMP4J. To
 * provide another logging mechanism as the default no-logging the static method
 * {@link LogFactory#setLogFactory} can be used to assign a different logging
 * adapter factory.
 *
 * @author Frank Fock
 * @version 1.6.1
...
public interface LogAdapter {
    ...
    /**
     * Returns the log level that is effective for this log adapter. The
     * effective log level is the first log level different from
