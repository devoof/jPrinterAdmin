...
/**
 * A
 * <code>LogProxy</code> can be used for late binding loggers. A proxy does not
 * log anything, if its logger member is
 * <code>null</code>. Otherwise it forwards all its messages to that logger.
 * Even if the proxy logger is not set, the
 * <code>LogProxy</code> has a name.
 *
 * @author Frank Fock
 * @version 1.8
 */
