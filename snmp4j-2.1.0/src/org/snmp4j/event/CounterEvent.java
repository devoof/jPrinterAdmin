 ...
 * <p>
 * At the same time a
 * <code>CounterEvent</code> can be used by the event originator to retrieve the
 * actual value of the specified counter. Listeners that maintain the specified
 * counter value, must set the new value when receiving the
 * <code>CounterEvent</code> by using the
 * {@link #setCurrentValue(Variable currentValue)} method.
 *
 * @author Frank Fock
 * @version 1.0
 */
public class CounterEvent extends EventObject {
    ...
    /**
     * Creates a
     * <code>CounterEvent</code> for the specified counter.
     *
     * @param source the source of the event.
     * @param oid the OID of the counter instance (typically, the counter is a
     * scalar and thus the OID has to end on zero).
     */
