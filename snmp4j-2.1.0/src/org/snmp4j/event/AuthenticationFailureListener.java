...
/**
 * The
 * <code>AuthenticationFailureListener</code> listens for authentication failure
 * events.
 *
 * @author Frank Fock
 * @version 1.5
...
public interface AuthenticationFailureListener extends EventListener {
     ...
     *
     * @param event a <code>AuthenticationFailureEvent</code> describing the
     * type of authentication failure, the offending message, and its source
