...
/**
 * The
 * <code>SecurityLevel</code> interface contains enumerated values for the
...
public enum SecurityLevel {
    ...
    authPriv(3);
    /**
     * No authentication and no encryption. Anyone can create and read messages
     ...
     * anyone can read the contents of the message.
     */
    public static final int AUTH_NOPRIV = 2;
    /**
     * Authentication and encryption. Only the one with the right authentication
     * key can create messages with this security level, and only the one with
     * the right encryption/decryption key can read the contents of the message.
     */
     ...
     *
     * @return 1 for noAuthNoPriv 2 for authNoPriv 3 for authPriv
     */
