...
/**
 * The
 * <code>SecurityParameters</code> interface represents the security parameters
 * in a SNMPv3 message.
 *
 * @author Frank Fock
 * @version 1.0
...
public interface SecurityParameters extends BERSerializable {
     ...
     *
     * @return the position of the first byte (counted from zero) of the
     * security parameters in the whole SNMP message. -1 is returned, when the
     * position is unknown (not set).
     */
