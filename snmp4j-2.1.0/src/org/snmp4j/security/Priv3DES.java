 ...
 *
 * This class uses DES-EDE in CBC mode to encrypt the data. The protocol is
 * defined by the Internet Draft 'Extension to the User-Based Security Model
 * (USM) to Support Triple-DES EDE in "Outside" CBC Mode'.
 *
