...
/**
 * The
 * <code>CertifiedTarget</code> class implements a {@link SecureTarget} for
 * usage with {@link org.snmp4j.security.SecurityModel}s that support secured
 * connections using client and server certificates.
 *
 * @author Frank Fock
 * @version 2.0
 * @since 2.0
