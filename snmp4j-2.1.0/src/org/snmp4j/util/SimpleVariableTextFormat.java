...
/**
 * The
 * <code>SimpleVariableTextFormat</code> implements a simple textual
 * representation for SNMP variables based on their type only. No MIB
 * information is used (can be used).
 *
 * @author Frank Fock
 * @version 1.10
 * @since 1.10
