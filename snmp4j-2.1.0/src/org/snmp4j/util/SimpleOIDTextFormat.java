...
/**
 * The
 * <code>SimpleOIDTextFormat</code> implements a simple textual representation
...
public class SimpleOIDTextFormat implements OIDTextFormat {
    ...
    /**
     * Returns a textual representation of a raw object ID as dotted string
     * ("1.3.6.1.4").
     *
     ...
     * "1.3.6.1.2.1.1") and returns its raw value.
     *
