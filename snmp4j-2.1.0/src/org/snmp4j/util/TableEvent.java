...
/**
 * The
 * <code>TableEvent</code> class reports events in a table retrieval operation.
 *
 * @author Frank Fock
 * @version 1.8
 * @since 1.0.2
...
public class TableEvent extends RetrievalEvent {
     ...
     * @param cols an array of <code>VariableBinding</code> instances containing
     * the elements of the row. The array may contain <code>null</code> elements
     * which indicates that the agent does not return an instance for that
     * column and row index. If an element is not <code>null</code>, then * the <code>OID</code> of the variable binding contains the full
     * instance <code>OID</code> of the variable.
     */
     ...
     *
     * @return the row's index OID or <code>null</code> if {@link #isError()}
     ...
     * which indicates that the agent does not return an instance for that
     * column and row index. If an element is not <code>null</code>, then * the <code>OID</code> of the variable binding contains the full
     * instance <code>OID</code> of the variable.<p>
     * If {@link #isError()} returns <code>true</code>, <code>null</code> will
     * be returned.
     */
