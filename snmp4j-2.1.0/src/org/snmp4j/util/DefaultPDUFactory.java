...
/**
 * The
 * <code>DefaultPDUFactory</code> is a default implementation of the
 * <code>PDUFactory</code> interface. It creates PDUs depending on the target's
 * message processing model. That is, a {@link PDUv1} instance is created for a
 * SNMPv1 target whereas a {@link ScopedPDU} is created for a SNMPv3 target. In
 * all other cases a {@link PDU} instance is created.
 *
 * @author Frank Fock
 * @version 1.7.3
 * @since 1.0.4
...
public class DefaultPDUFactory implements PDUFactory {
    ...
    /**
     * Create a
     * <code>PDU</code> instance for the supplied target.
     *
    ...
    /**
     * Create a
     * <code>PDU</code> instance for the specified SNMP version.
     *
     * @param targetVersion a SNMP version as defined by {@link SnmpConstants}.
     * @return a PDU instance that is compatible with the supplied target SNMP
     * version.
     * @since 1.7.3
     */
