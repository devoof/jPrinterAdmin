...
/**
 * The
 * <code>SchedulerTask</code> extends the
 * <code>Runnable</code> interface by methods that are needed for recurrent
 * execution of a task.
 *
 * @author Frank Fock
 * @version 1.9
...
public interface SchedulerTask extends WorkerTask {
    ...
    /**
     * Returns
     * <code>true</code> if this task is finished and should never be executed
     * again.
     *
