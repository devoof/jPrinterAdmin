...
/**
 * The
 * <code>TaskScheduler</code> uses a
 * <code>ThreadPool</code> to recurrent execute
 * <code>SchedulerTask</code>s.
 *
 * @author Frank Fock
 * @version 1.6
 * @since 1.6
...
public class TaskScheduler implements Runnable {
    ...
    /**
     * Creates a
     * <code>TaskScheduler</code> that uses the supplied
     ...
     *
     * @param task the <code>SchedulerTask</code> to be removed from the
     * scheduler
     ...
     *
     * @return <code>true</code> if the scheduler has been stopped or is being
     * stopped.
     */
