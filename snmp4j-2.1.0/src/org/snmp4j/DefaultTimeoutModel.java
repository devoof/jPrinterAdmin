...
/**
 * The
 * <code>DefaultTimeoutModel</code> implements a timeout model that uses
 * constant timeouts between retries.
 * <p>
 * The total time waited before a request is timed out is therefore:
 * <code>(totalNumberOfRetries + 1) * targetTimeout</code> where each (re)try is
 * timed out after
 * <code>targetTimeout</code> milliseconds.
 *
 * @author Frank Fock
 * @version 1.0
 */
