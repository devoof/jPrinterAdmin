...
/**
 * The
 * <code>MessageDispatcherImpl</code> decodes and dispatches incoming messages
 * using {@link MessageProcessingModel} instances and encodes and sends outgoing
 * messages using an appropriate {@link TransportMapping} instances.
 * <p>
...
public class MessageDispatcherImpl implements MessageDispatcher {
    ...
    /**
     * Adds a transport mapping. When an outgoing message is processed where no
     * specific transport mapping has been specified, then the message
     * dispatcher will use the transport mapping that supports the supplied
     * address class of the target.
     *
     * @param transport a TransportMapping instance. If there is already another
     * transport mapping registered that supports the same address class, then
     ...
     * @return the supplied TransportMapping if it has been successfully
     ...
     * <code>TransportMapping</code> that has been assigned for the supplied
     * address type.
     *
     ...
     * @throws IOException if an I/O error occurred while sending the message or
     * if there is no transport mapping defined for the supplied address type.
     */
     ...
     * a SNMP message to <code>destAddress</code> or <code>null</code> if such a
     * transport mapping does not exists.
     * @since 1.6
     */
    ...
    /**
     * Actually decodes and dispatches an incoming SNMP message using the
     * supplied message processing model.
     *
     *
     * @param sourceTransport a <code>TransportMapping</code> that matches the
     * incomingAddress type.
     * @param mp a <code>MessageProcessingModel</code> to process the message.
     * @param incomingAddress the <code>Address</code> from the entity that sent
     * this message.
     * @param wholeMessage the <code>BERInputStream</code> containing the SNMP
     * message.
     * @param tmStateReference the transport model state reference as defined by
     * RFC 5590.
     ...
     * @throws MessageException if unrecoverable inconsistencies have been
     * detected.
     */
    ...
    /**
     * Fires a
     * <code>CommandResponderEvent</code>. Listeners are called in order of
     * their registration until a listener has processed the PDU successfully.
     *
    ...
    /**
     * Gets the
     * <code>MessageProcessingModel</code> for the supplied message processing
     * model ID.
     *
     * @param messageProcessingModel a message processing model ID (see
     * {@link MessageProcessingModel#getID()}).
     ...
     * <code>CounterListener</code>.
     *
     * @param counterListener a <code>CounterListener</code> that will be
     * informed when a counter needs to incremented.
     */
     ...
     *
     * @param event the <code>CounterEvent</code> containing the OID of the
    ...
    /**
     * Enables or disables the consistency checks for outgoing messages. If the
     * checks are enabled, then GETBULK messages sent to SNMPv1 targets will be
     * converted to GETNEXT messages.
     * <p>
     * In general, if an automatically conversion is not possible, an error is
     * thrown when such a message is to be sent.
     * <p>
     * The default is consistency checks enabled.
     *
     * @param checkOutgoingMsg if <code>true</code> outgoing messages are
     * checked for consistency. Currently, only the PDU type will be checked
     * against the used SNMP version. If <code>false</code>, no checks will be
     * performed.
     */
     ...
     *
     * @return if <code>true</code> outgoing messages are checked for
     * consistency. If <code>false</code>, no checks are performed.
     */
    ...
    /**
     * Adds a listener for authentication failure events caused by
     * unauthenticated incoming messages.
     *
    ...
    /**
     * Removes an
     * <code>AuthenticationFailureListener</code>.
     *
    ...
    /**
     * Fires an
     * <code>AuthenticationFailureEvent</code> to all registered listeners.
     *
