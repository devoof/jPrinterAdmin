...
/**
 * The
 * <code>TimeTicks</code> class represents the time in 1/100 seconds since some
 * epoch (which should be have been defined in the corresponding MIB
 * specification).
 *
 * @author Frank Fock
 * @version 1.7
...
public class TimeTicks extends UnsignedInteger32 {
     ...
     * <code>TimeTicks</code> object as "[days,]hh:mm:ss.hh".
     *
     ...
     * <code>TimeTicks</code> object according to a supplied
     * <code>MessageFormat</code> pattern.
     *
     * @param pattern a <code>MessageFormat</code> pattern that takes up to five
     * parameters which are: days, hours, minutes, seconds, and 1/100 seconds.
