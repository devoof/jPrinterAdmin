...
/**
 * The
 * <code>Address</code> interface serves as a base class for all SNMP transport
 * addresses.
 * <p>
 * Note: This class should be moved to package
 * <code>org.snmp4j</code> in SNMP4J 2.0.
 * </p>
 *
 * @author Frank Fock
 * @version 2.0
...
public interface Address extends AssignableFromString, AssignableFromByteArray {
    ...
    /**
     * Checks whether this
     * <code>Address</code> is a valid transport address.
     *
     ...
     * Otherwise an {@link IllegalArgumentException} runtime exception is
     * thrown.
     *
