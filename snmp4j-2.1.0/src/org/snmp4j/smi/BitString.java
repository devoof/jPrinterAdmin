...
/**
 * The
 * <code>BitString</code> class represents the obsolete SMI type BIT STRING
 * which has been defined in RFC 1442 (an SNMPv2 draft) but which has been
 * obsoleteted by RFC 1902 and RFC 2578. This type is provided for compatibility
 * only and should not be used for new applications.
 *
 * @author Frank Fock
 * @version 1.7.4
 * @since 1.7.4
...
public class BitString extends OctetString {
     ...
     * and obsoleted by RFC 2578. Use OctetString (i.e. BITS syntax) instead.
     */
    public BitString() {
    }
