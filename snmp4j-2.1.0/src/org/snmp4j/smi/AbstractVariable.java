...
/**
 * The
 * <code>Variable</code> abstract class is the base class for all SNMP
 * variables.
 * <p>
 ...
 * it has to be specified relative to the
...
public abstract class AbstractVariable implements Variable, Serializable {
    ...
    /**
     * The abstract
     * <code>Variable</code> class serves as the base class for all specific
     * SNMP syntax types.
     */
     ...
     * <code>Variable</code> in bytes when encoded according to the Basic
     * Encoding Rules (BER).
     *
    ...
    /**
     * Creates a
     * <code>Variable</code> from a BER encoded
     * <code>InputStream</code>. Subclasses of
     * <code>Variable</code> are registered using the properties file
     * <code>smisyntaxes.properties</code> in this package. The properties are
     * read when this method is called first.
     *
     * @param inputStream an <code>BERInputStream</code> containing a BER
     * encoded byte stream.
    ...
    /**
     * Creates a
     * <code>Variable</code> from the supplied SMI syntax identifier. Subclasses
     * of
     * <code>Variable</code> are registered using the properties file
     * <code>smisyntaxes.properties</code> in this package. The properties are
     * read when this method is called for the first time.
     *
     * @param smiSyntax an SMI syntax identifier of the registered types, which
     * is typically defined by {@link SMIConstants}.
     * @return a <code>Variable</code> variable instance of the supplied SMI
     * syntax.
     */
     ...
     * instantiate sub-classes from
     * <code>Variable</code> from an BER encoded
     * <code>InputStream</code>.
     */
     ...
     * for exception values like noSuchObject, noSuchInstance, and endOfMibView.
     */
    public abstract int getSyntax();

    /**
     * Checks whether this variable represents an exception like noSuchObject,
     * noSuchInstance, and endOfMibView.
     *
     * @return <code>true</code> if the syntax of this variable is an instance
     * of <code>Null</code> and its syntax equals one of the following:
     * <UL>
     ...
     * @return a textual description like 'Integer32' for <code>syntax</code> as
     * used in the Structure of Management Information (SMI) modules. '?' is
     * returned if the supplied syntax is unknown.
     */
     ...
     *
     * @return a textual description like 'Integer32' as used in the Structure
     * of Management Information (SMI) modules. '?' is returned if the syntax is
     * unknown.
     * @since 1.7
     */
    ...
    /**
     * Returns the BER syntax ID for the supplied syntax string (as returned by
     * {@link #getSyntaxString(int)}).
     *
     ...
     * <code>Variable</code> to a (sub-)index value.
     *
     ...
     * {@link OctetString} and {@link OID}). For other variables it has no
     * effect.
     ...
     * <code>Variable</code> from the supplied (sub-)index.
     *
