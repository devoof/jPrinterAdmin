...
/**
 * The
 * <code>Variable</code> interface defines common attributes of all SNMP
 * variables.
 * <p>
...
public interface Variable extends Cloneable, Comparable<Variable>, BERSerializable {
     ...
     * <p>
     * In order to ensure proper synchronization if a
     * <code>Variable</code> is dynamic, modifications of the variables content
     * need to synchronize on the
     * <code>Variable</code> instance. This can be achieved for the standard SMI
     * Variable implementations for example by
     * <pre>
     ...
     * <code>false</code> if the value is immutable or if its value does not
     * change while serialization because of measures taken by the implementor
     * (i.e. variable cloning).
     */
    boolean isDynamic();
}
