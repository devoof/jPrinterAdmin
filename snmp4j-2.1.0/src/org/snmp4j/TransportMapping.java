...
/**
 * The
 * <code>TransportMapping</code> defines the common interface for SNMP transport
 * mappings. A transport mapping can only support a single transport protocol.
 *
 * @author Frank Fock
 * @version 2.0
 */
public interface TransportMapping<A extends Address> {
    ...
    /**
     * Gets the
     * <code>Address</code> class that is supported by this transport mapping.
     *
     ...
     *
     * @return the address for incoming packets or <code>null</code> this
     * transport mapping is not configured to listen for incoming packets.
     * @since 1.6
     */
    A getListenAddress();
     ...
     *
     * @param address an <code>Address</code> instance denoting the target
     * address.
     ...
     * @throws IOException if any underlying IO operation fails.
     */
     ...
     * propagated to the supplied
     * <code>TransportListener</code>.
     *
     * @param transportListener a <code>TransportListener</code> instance.
     * @since 1.6
     */
     ...
     * first time.
     *
     * @throws IOException if an IO operation exception occurs while starting
     * the listener.
     */
    ...
    /**
     * Returns
     * <code>true</code> if the transport mapping is listening for incoming
     * messages. For connection oriented transport mappings this is a
     * prerequisite to be able to send SNMP messages. For connectionless
     * transport mappings it is a prerequisite to be able to receive responses.
     *
     * @return <code>true</code> if this transport mapping is listening for
     * messages.
     * @since 1.1
     */
    boolean isListening();
