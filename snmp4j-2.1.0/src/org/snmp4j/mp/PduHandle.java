...
/**
 * The
 * <code>PduHandle</code> class represents an unique key for a SNMP PDU. It uses
 * an unique transaction ID (request ID) to identify the PDUs.
 *
 * @author Frank Fock
 * @version 1.0.3
 * @since 1.0
...
public class PduHandle implements Serializable {
    ...
    /**
     * Creates a
     * <code>PduHandle</code> with a transaction ID set to {@link #NONE}.
     */
    public PduHandle() {
    }
    ...
    /**
     * Creates a
     * <code>PduHandle</code> for the supplied transaction ID.
     *
