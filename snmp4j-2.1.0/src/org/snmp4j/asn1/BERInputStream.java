...
/**
 * The
 * <code>BERInputStream</code> class wraps a
 * <code>ByteBuffer</code> and implements the
 * <code>InputStream</code> abstract class. positions in the input stream.
 *
 * @author Frank Fock
 * @version 1.6.1
 */
public class BERInputStream extends InputStream {
     ...
     * @return the total number of bytes read into the buffer,      * or <code>-1</code> is there is no more data because the end of the
    ...
    /**
     * Reads up to
     * <code>len</code> bytes of data from the input stream into an array of
     * bytes.
     *
     * @param b the buffer into which the data is read.
     ...
     * @return the total number of bytes read into the buffer,      * or <code>-1</code> if there is no more data because the end of the
     * stream has been reached.
     * @throws IOException if an I/O error occurs.
     */
     ...
     * <code>n</code> bytes of data from this input stream.
     *
     ...
     * to determine whether the value returned by {@link #available()} is
     * limited by a readlimit set when the mark has been set.
     *
     * @return always <code>true</code>. If no mark has been set explicitly, the
     * mark is set to the initial position (i.e. zero).
     */
