...
/**
 * The
 * <code>LogControl</code> tool can be used to control the log levels of agents
 * implementing the SNMP4J-LOG-MIB.
 *
 * Run
 * <code>java -cp SNMP4J.jar org.snmp4j.tools.console.LogControl help</code> to
 * get help and command usage.
 *
 * @author Frank Fock
 * @version 1.10
 * @since 1.10
