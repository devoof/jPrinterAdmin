...
/**
 * The
 * <code>DefaultTcpTransportMapping</code> implements a TCP transport mapping
 * with the Java 1.4 new IO API.
 * <p>
...
public class DefaultTcpTransportMapping extends TcpTransportMapping {
     ...
     *
     * @throws SocketException when the transport is already listening for
     ...
     * called for this transport mapping or if SNMP4J is configured to use a
     * non-default thread factory.
     *
     ...
     * @throws IOException if the remote address cannot be closed due to an IO
     * exception.
     * @since 1.7.1
     */
