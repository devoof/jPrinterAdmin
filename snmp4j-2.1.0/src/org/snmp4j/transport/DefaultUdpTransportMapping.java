...
/**
 * The
 * <code>DefaultUdpTransportMapping</code> implements a UDP transport mapping
 * based on Java standard IO and using an internal thread for listening on the
 * inbound socket.
 *
 * @author Frank Fock
 * @version 1.9
...
public class DefaultUdpTransportMapping extends UdpTransportMapping {
     ...
     *
     * @param udpAddress the local address for sending and receiving of UDP
     * messages.
     * @param reuseAddress if <code>true</code> addresses are reused which
     * provides faster socket binding if an application is restarted for
     * instance.
     * @throws IOException if socket binding fails.
     * @since 1.7.3
     */
     ...
     * effective.
     *
     * @param receiveBufferSize an integer value >0 and >
     * {@link #getMaxInboundMessageSize()}.
     */
     ...
     *
     * @param socketTimeout the socket timeout for incoming messages in
