...
/**
 * The
 * <code>TransportStateEvent</code> describes a state change for a transport
 * connection. Optionally, connection establishment can be cancelled.
 *
 * @author Frank Fock
 * @version 1.8
 * @since 1.7
...
public class TransportStateEvent extends EventObject {
     ...
     * {@link #STATE_CONNECTED} events can be canceled.
     *
     * @param cancelled <code>true</code> if the event should be canceled, i.e.
     * a connection attempt should be rejected.
     * @since 1.8
     */
