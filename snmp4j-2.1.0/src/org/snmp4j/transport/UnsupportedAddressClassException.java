...
/**
 * The
 * <code>UnsupportedAddressClassException</code> indicates a message exception
 * caused by unsupported address class. When this exception is thrown, the
 * target address class is not supported by the entity that is to sent the
 * message and that operation will be canceled.
 *
 * @author Frank Fock
 * @version 1.6
 */
