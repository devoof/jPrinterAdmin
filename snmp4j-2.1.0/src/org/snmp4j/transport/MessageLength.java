...
/**
 * The
 * <code>MessageLength</code> object contains information about the length of a
 * message and the length of its header.
 *
 * @author Frank Fock
 * @version 1.7
 * @since 1.7
...
public class MessageLength implements Serializable {
     ...
     *
     * @return the sum of {@link #getHeaderLength()} and
