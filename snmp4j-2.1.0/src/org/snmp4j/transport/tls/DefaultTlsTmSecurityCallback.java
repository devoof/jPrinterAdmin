...
/**
 * The
 * <code>DefaultTlsTmSecurityCallback</code> resolves the
 * <code>tmSecurityName</code> for incoming requests through a mapping table
 * based on the peer certificates, resolves the local certificate alias through
 * a mapping table based on the target address and accepts peer certificates
