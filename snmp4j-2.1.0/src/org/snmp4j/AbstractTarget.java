...
/**
 * A
 * <code>AbstratTarget</code> class is an abstract representation of a remote
 ...
 * <code>Target</code> interface can subclass
 * <code>AbstractTarget</code> to take advantage of the implementation of common
 * <code>Target</code> properties.
 *
 * @author Frank Fock
 * @version 2.0
 * @since 1.2
...
public abstract class AbstractTarget implements Target {
     ...
     *
     * @param retries the number of retries. <em>Note: If the number of retries
     * is set to 0, then the request will be sent out exactly once.</em>
     */
     ...
     *
     * @param timeout timeout in milliseconds before a confirmed request is
     * resent or timed out.
     */
     ...
     * receive.
     *
     * @param maxSizeRequestPDU the maximum PDU (SNMP message) size this session
     ...
     * will be chosen by the supplied
     * <code>address</code> of the target. If an entity supports more than one
     * {@link TransportMapping} for an {@link Address} class, the the results
     * are not defined. This situation can be controlled by setting this
     * preferredTransports list.
     *
     * @since 2.0
     */
     ...
     *
     * @param securityModel an <code>int</code> value as defined in the
     * {@link org.snmp4j.security.SecurityModel} interface or any third party
     * subclass thereof.
     */
